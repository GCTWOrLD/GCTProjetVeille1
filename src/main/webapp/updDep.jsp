...
<body>
	...
	<div class="container">
		<form method="post" name="updDep" action="adminController?action=updateDep">
			<label>ID:</label><input type="text" name="newID" value="${depToUpd.id}"/></br>
			<label>Nom:</label><input type="text" name="newNom" value="${depToUpd.nom}"/></br>
			<input class="boutton" type="submit" value="Mettre à jour"/>
		</form>
	</div>
	<div id="footer">
		<a href="dep.jsp">Retour</a>
	</div>
</body>
</html>